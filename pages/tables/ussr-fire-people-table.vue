    ...
    return {
      ...
      data: [
		  // 数据不对，要改
            ...
            ['TM',   9, 8, 7, 6, 4, 4, 4, 3, 2, 2, '*', '*', '*', '*', '*', '*'],
            ['MG',   8, 8, 8, 8, 8, 8, 7, 7, 7, 7, 6, 4, '*', '*', '*', '*'],
            ['MG+',  8, 8, 8, 8, 7, 7, 7, 7, 7, 7, 6, 6, '*', '*', '*', '*'],
            ['BMP',  10, 10, 10, 10, 9, 9, 9, 9, 9, 9, 9, 8, 7, 6, 4, 2],
            ['T62',  9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 8, 6, 4, 3, 2],
            ['XMBT', 8, 8, 8, 8, 8, 8, 7, 7, 7, 6, 5, 3, 1, '*', '*', '*']
      ]
    };
  },
  methods: {
